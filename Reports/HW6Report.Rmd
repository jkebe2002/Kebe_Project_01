...
Here we used a boxplot to visualize the IQ's for the "Near" group and the "Far Group". Notably, the Far group has an outlier of an individual with extraordinary IQ. The outlier makes comparing the groups visually difficult. \
## Means by Group
```{r means}
