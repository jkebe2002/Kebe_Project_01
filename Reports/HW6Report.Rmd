...
boxplot(IQ~Smelter, data = leadData, xlab = "Relative Distance to Smelter")
```
...
Our mean IQs for the two groups were `r mean(leadData[leadData$Smelter == "Near",]$IQ)` for the near group and `r mean(leadData[leadData$Smelter == "Far",]$IQ)` for the far group.
